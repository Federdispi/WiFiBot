...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        affichage_robot->setGeometry(QRect(750, 10, 211, 401));
        ...
        ir_ArD->setGeometry(QRect(100, 340, 91, 61));
        ...
        ir_ArG->setGeometry(QRect(0, 340, 91, 61));
        ...
        ir_AvD->setGeometry(QRect(100, 280, 91, 61));
        ...
        ir_AvG->setGeometry(QRect(0, 280, 91, 61));
